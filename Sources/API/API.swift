...
public extension API {
    ...
    where M: Modifier {
        ...
        return _API<Parameters, Returns, TupleModifier2>(body: tuple2)
    }
    ...
    where M0: Modifier, M1: Modifier {
        ...
        return _API<Parameters, Returns, TupleModifier3>(body: tuple3)
    }
    ...
    where M0: Modifier, M1: Modifier, M2: Modifier {
        ...
        return _API<Parameters, Returns, TupleModifier4>(body: tuple4)
    }
}


// MARK: - Internal
struct _API<Parameters, Returns, Body: Modifier>: API {
